...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__content__ = __webpack_require__(875);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_accordion_accordion__ = __webpack_require__(877);
    ...
    ContentPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_4__components_accordion_accordion__["a" /* AccordionComponent */]
            ],
            imports: [
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__node_modules_angular_common_http__ = __webpack_require__(167);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_data_data_service__ = __webpack_require__(510);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_jquery__ = __webpack_require__(876);
...
var ContentPage = /** @class */ (function () {
    function ContentPage(navCtrl, afAuth, auth, http) {
        // this.auth.user
        ...
        this.http = http;
        this.isLoaded = false;
        this.auth.getUserById(this.auth.user.uid).subscribe(function (data) {
            // console.log("this is from the content constructor")
            // console.log(data);
            // assigning the DB data to userInfo variable
            _this.userInfo = data;
            console.log("User first name is = " + _this.userInfo.PatientFirstName);
            _this.isLoaded = true;
        });
    }
    ContentPage.prototype.logout = function () {
    ...
    var readURL = function (input) {
        if (input.files && input.files[0]) {
            ...
            reader.onload = function (e) {
                var target = e.target; //<-- This (any) will tell compiler to shut up!
                var content = target.result;
                __WEBPACK_IMPORTED_MODULE_5_jquery__(".profile-pic").attr("src", target.result);
            };
            reader.readAsDataURL(input.files[0]);
        }
    };
    __WEBPACK_IMPORTED_MODULE_5_jquery__(".file-upload").on("change", function () {
        readURL(this);
    });
    __WEBPACK_IMPORTED_MODULE_5_jquery__(".upload-button").on("click", function () {
        __WEBPACK_IMPORTED_MODULE_5_jquery__(".file-upload").click();
    });
});
// How Are You Feeling
__WEBPACK_IMPORTED_MODULE_5_jquery__(document).ready(function () {
    var readURL = function (input) {
        if (input.files && input.files[0]) {
            ...
            // };
            reader.onload = function (e) {
                __WEBPACK_IMPORTED_MODULE_5_jquery__(".profile-pic").attr("src");
            };
            reader.readAsDataURL(input.files[0]);
        }
    };
...
// How Are You Feeling
__WEBPACK_IMPORTED_MODULE_5_jquery__(".pain-scale__level").hover(function () {
    __WEBPACK_IMPORTED_MODULE_5_jquery__(this)
...
__WEBPACK_IMPORTED_MODULE_5_jquery__(".pain-scale__level").click(function () {
    __WEBPACK_IMPORTED_MODULE_5_jquery__(this)
        .siblings()
    ...
    __WEBPACK_IMPORTED_MODULE_5_jquery__(this)
        ...
        __WEBPACK_IMPORTED_MODULE_5_jquery__(this).removeClass("pain-scale__level--blink");
    });
    __WEBPACK_IMPORTED_MODULE_5_jquery__(this)
        .prevAll()
        .addClass("pain-scale__level--selected pain-scale__level--blink")
...
var bpm = setInterval(function () {
    ...
    __WEBPACK_IMPORTED_MODULE_5_jquery__('.heartRateCounter').text(rand);
});
...
var AccordionComponent = /** @class */ (function () {
    ...
    AccordionComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'accordion',template:/*ion-inline-start:"/Users/remy/code/DestinyHealthTracker/src/components/accordion/accordion.html"*/'<!-- Generated template for the AccordionComponent component -->\n<ion-card>\n    <ion-card-header round (click)="toggleAccordion()">\n      <ion-list no-lines>\n        <ion-item color="primary">\n          <button ion-button clear small icon-only item-right>\n            <ion-icon color="light" [name]="icon"></ion-icon>\n          </button>\n          {{ title }} \n        </ion-item>\n      </ion-list>\n    </ion-card-header>\n    <ion-card-content #cc>\n      <ng-content></ng-content>\n    </ion-card-content>\n  </ion-card>\n'/*ion-inline-end:"/Users/remy/code/DestinyHealthTracker/src/components/accordion/accordion.html"*/
        }),
